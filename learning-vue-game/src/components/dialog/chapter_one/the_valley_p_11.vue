        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    ...
                    <p>You pass a young girl yelling at an old man selling flowers. "No, you stupid old fart. I asked for the pink one, not the green one! I want the PINK one!"</p>
                    <p>You shake your head in disbelief and carry on towards the West Gate a short distance ahead. As you approach the gate, an oddly obese elf in dark clothing approaches. "There you are! Stop! You will not pass through this gate."</p>
                    <p>In an attempt to avoid an altercation you try to sidestep around the pointy eared slob, but he grabs you by the shirt. "I said, stop. Your journey ends here.</p>
                    <p>Looks like you are going to have to teach this elf some manners.</p>
...
<script>
    ...
    export default {
        name: 'the_valley_p_11',
            data () {
                return {
                    ...
                    monster:{
                        ...
                        monsterHealth:10,
                        monsterName:'Fat Elf',
                        monsterText:'A obese elf block your way. You should be able to take him.',
                        monsterDiedText:'The fat Elf slumps forward, gasps a bit of blood, and falls to the ground dead.',
                        monsterDeadtext:'There is an obese Elf dead on the ground. A crowd has gathered.'
                    },
                    hiddenItem:{
            ...
            created() {
                //TODO add the comit statement below to other views. Add the local data this.overworldMapToDisplay. Set the map by ID.
