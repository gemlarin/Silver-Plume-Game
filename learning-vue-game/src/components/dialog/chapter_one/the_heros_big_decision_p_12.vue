                ...
                <div class="col-12">
                    ...
                    <p>
                      ...
                      <p>The craggy trail winds through the Cat Scratch Pass down narrow passages, over and through the remnants of previous rockfalls. Not passable by cart, nor horse, it is generally safe for foot travel and is the fastest path to the Cat Scratch Inn. There are rumors of an old crone living among the crags, though noone has actually located any form of dwelling.</p>  
                        ...
                        <p>The sloping valley floor meanders along the flats of the Iros river for about ten miles before reaching the Dragon's Tongue and the pirate town that bears its name. While the pirates can be a rowdy bunch at sea, they are a notoriaously larger pain in the ass on land. </p>

                        <p>Whichever way the thief went there is a mass of folks that would have noticed a stranger in their midst. Some friendlier than others.</p>
...
<script>
    ...
    export default {
        name: 'the_heros_big_decision_p_12',
            data () {
                return {
                    roomID:'p_12',
                    searchDifficulty:1,
                    overworldMapToDisplay:'overlandmap_p11.png',
