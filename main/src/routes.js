import PageNotFound from './components/dialog/404.vue'
import Inventory from './components/dialog/inventory.vue'
import PlayerInit from './components/player/playerinit.vue'
import Map from './components/dialog/map.vue'
import Death from './components/dialog/death.vue'
import Journal from './components/dialog/journal'
